...
$(function() {
    var someCallback = function(exifObject) {
        ...
        $('#photoDate').val(exifObject.DateTime);
        $('#photoWidth').val(exifObject.PixelXDimension);
        $('#photoHeight').val(exifObject.PixelYDimension);
        $('#photoDeviceCorporation').val(exifObject.Make);
        $('#photoDeviceModel').val(exifObject.Model);
        $('#aperture').val('f/'+exifObject.FNumber);
        $('#photoExposureTime').val(exifObject.ExposureTime + ' seg.');
        $('#version').val(exifObject.ExifVersion);
        $('#photoFlashMode').val(exifObject.Flash);
        $('#photoFocalLength').val(exifObject.FocalLength + 'mm');
    ...
    try {
        $('#photo-upload').change(function(e) {
            ...
            $('#photoType').val(fileArr[1]);
            $('#photoSize').val(this.files[0].size/1024+ " KB");
